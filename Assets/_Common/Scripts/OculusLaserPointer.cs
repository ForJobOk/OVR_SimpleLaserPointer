...
public class OculusLaserPointer : OVRCursor
{
    ...
    private static OculusLaserPointer _instance;
    public static OculusLaserPointer instance
    {
        ...
        get
        {
            if (_instance == null)
            {
                ...
                _instance = (OculusLaserPointer)GameObject.Instantiate((OculusLaserPointer)Resources.Load("Prefabs/GazePointerRing", typeof(OculusLaserPointer)));
            }
            return _instance;
        }
